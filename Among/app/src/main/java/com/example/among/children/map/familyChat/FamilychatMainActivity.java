...
import static com.example.among.children.map.Constants.ERROR_DIALOG_REQUEST;
import static com.example.among.children.map.Constants.PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION;
import static com.example.among.children.map.Constants.PERMISSIONS_REQUEST_ENABLE_GPS;
...
*/
public class FamilychatMainActivity extends AppCompatActivity implements
        ...
        ChatroomRecyclerAdapter.ChatroomRecyclerClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_familyroom);
        ...
        //인텐트 객체에서 공유된 값을 꺼내기
        String data = intent.getStringExtra("Chatrooms");
        Toast.makeText(this,"추출한 값:"+data,
    ...
    private void startLocationService(){
        if(!isLocationServiceRunning()){
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O){
                ...
                FamilychatMainActivity.this.startForegroundService(serviceIntent);
            }else{
    ...
    public boolean isServicesOK(){
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(FamilychatMainActivity.this);
        ...
        if(available == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(FamilychatMainActivity.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
        }else{
...
//        mDb.setFirestoreSettings(settings);
    ...
    private void navChatroomActivity(Chatroom chatroom){
        Intent intent = new Intent(FamilychatMainActivity.this, ChatroomActivity.class);
    ...
    private void newChatroomDialog(){
        ...
        builder.setTitle("가족방 이름을 기재하세요.");
        ...
        builder.setPositiveButton("CREATE", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if(!input.getText().toString().equals("")){
                    ...
                    Toast.makeText(FamilychatMainActivity.this, "가족 채팅방 생성", Toast.LENGTH_SHORT).show();
                }
            }
        });
